...
namespace IngameScript
{
    partial class Program
    {
        ...
        public class ScreenMenuItem
        {
            ...
            public ScreenMenuItem(string label, string varName, float width, string defaultValue, float fontSize = 1f)
            {
                ...
                bullet = new ScreenSprite(ScreenSprite.ScreenSpriteAnchor.CenterLeft, _postion, fontSize, new Vector2(0, 0), Color, "White", bulletIcon, TextAlignment.RIGHT, SpriteType.TEXT);
                this.label = new ScreenSprite(ScreenSprite.ScreenSpriteAnchor.CenterLeft, _postion, fontSize, new Vector2(1, 0), Color, "White", label, TextAlignment.LEFT, SpriteType.TEXT);
                _postion += new Vector2(width, 0);
                text = new ScreenSprite(ScreenSprite.ScreenSpriteAnchor.CenterLeft, _postion, fontSize, new Vector2(0, 0), Color, "White", GridInfo.GetVarAs<string>(variableName), TextAlignment.LEFT, SpriteType.TEXT);
                DisplayValue(GridInfo.GetVarAs<string>(variableName, defaultValue));
            }
            public ScreenMenuItem(string label, float width, string defaultValue, float fontSize = 1f)
            {
                ...
                this.label = new ScreenSprite(ScreenSprite.ScreenSpriteAnchor.CenterLeft, _postion, fontSize, new Vector2(1, 0), Color, "White", label, TextAlignment.LEFT, SpriteType.TEXT);
                _postion += new Vector2(width, 0);
                text = new ScreenSprite(ScreenSprite.ScreenSpriteAnchor.CenterLeft, _postion, fontSize, new Vector2(0, 0), Color, "White", defaultValue, TextAlignment.RIGHT, SpriteType.TEXT);
            }
            public ScreenMenuItem(string label, float width, float fontSize = 1f)
            {
                _postion = new Vector2(0, 0);
                _width = width;
                this.fontSize = fontSize;
